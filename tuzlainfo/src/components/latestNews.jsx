...
const LatesNews = ({blog, isLoading}) => {
        ...
        <div className="main-container mb-[70px]">
            ...
            <div className='flex flex-col gap-8'>
                ...
                <Link to={blog.length !==0 ? `/blog/${blog[3].idObjava}` : '/'} className='flex text-center md:text-left flex-col md:flex-row gap-10 bg-[#F5F5F5] p-5 rounded-[20px]'>
                    {!isLoading && <img src={blog.length !==0 && `/uploads/${blog[3].putanja_slike}`} alt="" className='md:max-w-[350px] lg:max-w-[400px] w-full rounded-md object-cover'/>}
                    {isLoading && blog.length===0 &&
                    <div className="md:w-[350px] lg:w-[400px] h-[266px] bg-black/30 rounded-md object-cover">
                    ...
                    <div className='flex flex-col justify-evenly'>
                        ...
                        <p className=' text-base md:text-lg font-semibold'>{blog.length !==0 && (blog[3].ime + " " + blog[3].prezime)} - {blog.length !==0 && new Date(blog[3].datum_objave).toDateString()}</p>
                    </div>
                </Link>
                ...
                <Link to={blog.length !==0 ? `/blog/${blog[4].idObjava}` : '/'} className='flex text-center md:text-left flex-col md:flex-row gap-10 bg-[#F5F5F5] p-5 rounded-[20px]'>
                    <img src={blog.length !==0 && `/uploads/${blog[4].putanja_slike}`} alt="" className='md:max-w-[350px] lg:max-w-[400px] w-full rounded-md object-cover'/>
                    <div className='flex flex-col justify-evenly'>
                        ...
                        <p className=' text-base md:text-lg font-semibold'>{blog.length !==0 && (blog[4].ime + " " + blog[4].prezime)} - {blog.length !==0 && new Date(blog[4].datum_objave).toDateString()}</p>
                    </div>
                </Link>
                ...
                <Link to={blog.length !==0 ? `/blog/${blog[5].idObjava}` : '/'} className='flex text-center md:text-left flex-col md:flex-row gap-10 bg-[#F5F5F5] p-5 rounded-[20px]'>
                    <img src={blog.length !==0 && `/uploads/${blog[5].putanja_slike}`} alt="" className='md:max-w-[350px] lg:max-w-[400px] w-full rounded-md object-cover'/>
                    <div className='flex flex-col justify-evenly'>
                        ...
                        <p className=' text-base md:text-lg font-semibold' id="popularno">{blog.length !==0 && (blog[5].ime + " " + blog[5].prezime)} - {blog.length !==0 && new Date(blog[5].datum_objave).toDateString()}</p>
                    </div>
                </Link>
