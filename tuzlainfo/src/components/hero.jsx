        ...
        <div className="main-container">
            ...
            <div className="img-grid">
                <div className="big-pic relative max-h-[525px]">
                    <Link to={blog.length !==0 ? `/blog/${blog[0].idObjava}` : '/'} className="absolute top-0 bottom-0 left-0 right-0 bg-black/30"></Link>
                    <img src={blog.length !==0 ? `/uploads/${blog[0].putanja_slike}` : img} alt="" className="md:h-[525px] md:w-[650px] overflow-hidden object-cover" />
                ...
                <div className="small-pic-1 relative">
                    <Link to={blog.length !==0 ? `/blog/${blog[1].idObjava}` : '/'} className="absolute top-0 bottom-0 left-0 right-0 bg-black/30"></Link>
                    <img src={blog.length !==0 ? `/uploads/${blog[1].putanja_slike}` : img} alt="" className="md:h-[250px] md:w-[550px] overflow-hidden object-cover" />
                ...
                <div className="small-pic-2 relative">
                    <Link to={blog.length !==0 ? `/blog/${blog[2].idObjava}` : '/'} className="absolute top-0 bottom-0 left-0 right-0 bg-black/30"></Link>
                    <img src={blog.length !==0 ? `/uploads/${blog[2].putanja_slike}` : img} alt="" className="md:h-[250px] md:w-[550px] overflow-hidden object-cover" />
                    <div className="absolute bottom-[35px] md:bottom-[50px] left-4">
