        ...
        <div className="main-container mb-[160px]">
            ...
            <div className='flex gap-8 md:flex-row xl:gap-0 justify-center xl:justify-between flex-wrap'>
                <Link to={blog.length !==0 ? `/blog/${blog[1].idObjava}` : '/'}>
                    <div className='max-w-[370px] bg-[#F5F5F5] p-5 rounded-[20px] min-h-full'>
                        <img src={blog.length !==0 && `/uploads/${blog[1].putanja_slike}`} alt="" className='max-w-[330px] w-full rounded-md'/>
                        <div className='pt-3'>
                ...
                <Link to={blog.length !==0 ? `/blog/${blog[0].idObjava}` : '/'}>
                    <div className='max-w-[370px] bg-[#F5F5F5] p-5 rounded-[20px] min-h-full'>
                        <img src={blog.length !==0 && `/uploads/${blog[0].putanja_slike}`} alt="" className='max-w-[330px] w-full rounded-md'/>
                        <div className='pt-3'>
                ...
                <Link to={blog.length !==0 ? `/blog/${blog[2].idObjava}` : '/'}>
                    <div className='max-w-[370px] bg-[#F5F5F5] p-5 rounded-[20px] min-h-full'>
                        <img src={blog.length !==0 && `/uploads/${blog[2].putanja_slike}`} alt="" className='max-w-[330px] w-full rounded-md'/>
                        <div className='pt-3'>
